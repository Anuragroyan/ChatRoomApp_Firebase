...
import com.example.trelloapp.data.Message
import com.example.trelloapp.data.MessageRepository
import com.example.trelloapp.data.Result.*
import com.example.trelloapp.data.User
import com.example.trelloapp.data.UserRepository
    ...
    private fun loadCurrentUser() {
        viewModelScope.launch {
            when (val result = userRepository.getCurrentUser()) {
                is Success<*> -> _currentUser.value = result.data as User?
                is Error -> {
